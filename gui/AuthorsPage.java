...
public class AuthorsPage extends JFrame {
    ...
    private void setupUI() {
        ...
        addButton.addActionListener(_ -> addAuthor(nameField, idField));
        JButton removeButton = new JButton("Remove Author");
        removeButton.addActionListener(_ -> removeAuthor());
        JButton viewBooksButton = new JButton("View Books by Author");
        viewBooksButton.addActionListener(_ -> viewBooksByAuthor());
