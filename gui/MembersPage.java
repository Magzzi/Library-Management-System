...
public class MembersPage extends JFrame {
    ...
    private void setupUI() {
        ...
        addButton.addActionListener(_ -> addMember(nameField, idField, borrowedBooksField));
        JButton removeButton = new JButton("Remove Member");
        removeButton.addActionListener(_ -> removeMember());
        JButton updateButton = new JButton("Update Member");
        updateButton.addActionListener(_ -> updateMember(nameField, idField, borrowedBooksField));
